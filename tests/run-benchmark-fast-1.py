...
def benchmark_scaled():
    target_folders = [
        "generated_tests/generate_test_dataset_1000f_500wpf",
        "generated_tests/generate_test_dataset_2000f_500wpf",
        "generated_tests/generate_test_dataset_3000f_500wpf",
        "generated_tests/generate_test_dataset_4000f_500wpf",
        "generated_tests/generate_test_dataset_5000f_500wpf",
        "generated_tests/generate_test_dataset_6000f_500wpf",
        "generated_tests/generate_test_dataset_7000f_500wpf",
        "generated_tests/generate_test_dataset_8000f_500wpf",
        "generated_tests/generate_test_dataset_9000f_500wpf",
        "generated_tests/generate_test_dataset_10000f_500wpf"
    ]
    ...
    for folder in target_folders:
        ...
        runs = [
            ...
            ("java", "bidecontiguousmaximal",f"java -cp {JAVA_CP} com.bloomspan.benchmarks.BenchmarkRunner bidecontiguousmaximal {folder} {sigma} {min_l} ")
        ]
